...
// configuration step. It creates a namespace called `vulkan_introduction`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", vulkan_introduction::cmake::project_name, vulkan_introduction::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", vulkan_introduction::cmake::project_version);
      return EXIT_SUCCESS;
    }
